	...
	<div class="container">
		...
		<div class="row mb2-half-p">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mlpl0">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hero-company" style="background-image: url('{$BASE_URL}{$company.profile_picture}')">
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="col-md-2">
							<div class="rise">
								<img id="profileLogo" class="company-logo img-responsive" src="{$BASE_URL}{$company.logo_path}" />
								<h1 class="company-name">{$company.name}</h1>
								<p class="location"><i class="fa fa-map-marker" aria-hidden="true">{$company.hq}</i></p>
							</div>
						</div>
