        ...
        <div id="employers-signup">
          <div class="row">   
            <div class="col-lg-12  col-md-12 col-sm-12 col-xs-12 c-box">
              <h1 class="volunteer-title">{$customizer_data.ta_emp_headline}</h1>
              <h2 class="volunteer-subtitle">{$customizer_data.ta_emp_subheadline}</h2>
              <a href="{$BASE_URL}{$URL_REGISTER_RECRUITERS}" ><button type="button" class="btn btn-subc btn-read-more">{$customizer_data.ta_emp_btn_label}</button></a>
            </div>
          </div>
        </div>
      </div>
